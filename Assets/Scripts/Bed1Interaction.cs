...
public class Bed1Interaction : MonoBehaviour, IInteractable
{
    ...
    private void OnArrivedAtBed()
    {
        ...
        agent.enabled = true;
        animator.SetTrigger("Bed1");
    }
    public void CancelInteraction()
    {
        if (!isWaitingForArrival)
        {
            animator.SetTrigger("StopBed1");
            playerMovement.TemporarilyDisableMovement(1f);
        }
    }
